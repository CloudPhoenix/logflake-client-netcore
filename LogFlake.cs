    ...
    public class LogFlake
    {
        ...
        private async Task<bool> Post(string queueName, string jsonString)
        {
            ...
            try
            {
                ...
                client.DefaultRequestHeaders.Add("User-Agent", "logflake-client-netcore/1.4.2");
        ...
        public void SendException(Exception e, string correlation)
        {
            ...
            if (e.Data.Count > 0)
            {
                ...
                additionalTrace.Append(
                    $"{Environment.NewLine}{JsonSerializer.Serialize(e.Data, new JsonSerializerOptions { WriteIndented = true })}");
            }
